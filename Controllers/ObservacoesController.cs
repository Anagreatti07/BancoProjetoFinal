...
namespace ApiProjetoFinal.Controllers
{
    public class ObservacoesController : Controller
    {
        ...
        {
            ViewData["ObjetoId"] = new SelectList(_context.Objeto, "Id", "ObjetoNome");
        ...
        public async Task<IActionResult> Create([Bind("Id,ObservacaoDescricao,ObservacaoLocal,ObservacaoData,ObjetoId,UsuarioId")] Observacoes observacoes)
        {
            ...
            ViewData["ObjetoId"] = new SelectList(_context.Objeto, "Id", "ObjetoNome", observacoes.ObjetoId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ObservacaoDescricao,ObservacaoLocal,ObservacaoData,ObjetoId,UsuarioId")] Observacoes observacoes)
        {
